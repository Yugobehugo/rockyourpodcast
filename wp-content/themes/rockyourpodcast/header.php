...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e( 'Skip to content', 'rockyourpodcast' ); ?></a>
	...
	<header id="masthead" class="site-header">
		<!-- <div class="site-branding">
			...
			$rockyourpodcast_description = get_bloginfo( 'description', 'display' );
			if ( $rockyourpodcast_description || is_customize_preview() ) :
				?>
