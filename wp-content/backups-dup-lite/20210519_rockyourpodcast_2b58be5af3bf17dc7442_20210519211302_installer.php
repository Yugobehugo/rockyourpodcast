...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210519_rockyourpodcast_2b58be5af3bf17dc7442_20210519211302_archive.zip';
	const ARCHIVE_SIZE		 = '91645716';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '2b58be5-19211302';
    const SECONDARY_PACKAGE_HASH = '447fe3a-19211302';
	const VERSION			 = '1.4.0';
